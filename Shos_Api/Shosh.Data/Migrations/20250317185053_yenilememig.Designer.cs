...
namespace Shosh.Data.Migrations
{
    ...
    [Migration("20250317185053_yenilememig")]
    partial class yenilememig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Ban", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Complaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Comment", b =>
                {
                    b.HasOne("Shosh.Core.Entities.Blog", null)
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Complaint", b =>
                {
                    b.HasOne("Shosh.Core.Entities.Blog", "Blog")
                        .WithMany()
                        .HasForeignKey("BlogId");
                    ...
                    b.HasOne("Shosh.Core.Entities.User", "TargetUser")
                        .WithMany()
