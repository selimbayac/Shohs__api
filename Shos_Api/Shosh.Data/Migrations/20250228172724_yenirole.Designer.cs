...
namespace Shosh.Data.Migrations
{
    ...
    [Migration("20250228172724_yenirole")]
    partial class yenirole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shosh.Core.Entities.Like", b =>
                {
                    b.HasOne("Shosh.Core.Entities.Entry", null)
                        .WithMany("Likes")
                        .HasForeignKey("EntryId");
            ...
            modelBuilder.Entity("Shosh.Core.Entities.UserFollow", b =>
                {
                    b.HasOne("Shosh.Core.Entities.User", "FollowedUser")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shosh.Core.Entities.User", "FollowingUser")
                        .WithMany("Following")
